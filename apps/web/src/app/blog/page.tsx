...
export const metadata: Metadata = {
  title: "Blog - SpryVibe Video Editor",
  description:
    "Read the latest news and updates about SpryVibe Video Editor, the free and open-source video editor.",
  openGraph: {
    title: "Blog - SpryVibe Video Editor",
    description:
      "Read the latest news and updates about SpryVibe Video Editor, the free and open-source video editor.",
        ...
        <div className="relative container max-w-3xl mx-auto px-4 py-16">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Read the latest news and updates about SpryVibe Video Editor, the free and
