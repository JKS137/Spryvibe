...
export const metadata: Metadata = {
  title: "Contributors - SpryVibe Video Editor",
  description:
    "Meet the amazing people who contribute to SpryVibe Video Editor, the free and open-source video editor.",
  openGraph: {
    title: "Contributors - SpryVibe Video Editor",
    description:
      "Meet the amazing people who contribute to SpryVibe Video Editor, the free and open-source video editor.",
...
async function getContributors(): Promise<Contributor[]> {
  try {
    const response = await fetch(
      "https://api.github.com/repos/JKS137/Spryvibe/contributors?per_page=100",
      {
        headers: {
          Accept: "application/vnd.github.v3+json",
          "User-Agent": "SpryVibe-Web-App",
        },
          ...
          <div className="max-w-6xl mx-auto">
            ...
            {otherContributors.length > 0 && (
              <div>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Everyone who makes SpryVibe Video Editor better
                  </p>
                </div>
            ...
            {contributors.length === 0 && (
              <div className="text-center py-20">
                ...
                <Link
                  href="https://github.com/JKS137/Spryvibe/graphs/contributors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="mt-6 mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground">
                  Tools we use to build SpryVibe Video Editor
                </p>
              </div>
            ...
            <div className="mt-32 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
                  SpryVibe Video Editor is built by developers like you. Every contribution,
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="https://github.com/JKS137/Spryvibe/blob/main/.github/CONTRIBUTING.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
