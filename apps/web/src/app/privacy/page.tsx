...
export const metadata: Metadata = {
  title: "Privacy Policy - SpryVibe Video Editor",
  description:
    "Learn how SpryVibe Video Editor handles your data and privacy. Our commitment to protecting your information while you edit videos.",
  openGraph: {
    title: "Privacy Policy - SpryVibe Video Editor",
    description:
      "Learn how SpryVibe Video Editor handles your data and privacy. Our commitment to protecting your information while you edit videos.",
            ...
            <Card className="bg-background/80 backdrop-blur-xs border-2 border-muted/30">
              <CardContent className="p-8 text-base leading-relaxed space-y-8">
                <section>
                  ...
                  <p className="mb-4">
                    <strong>
                      SpryVibe Video Editor processes all videos locally on your device.
                    </strong>{" "}
                ...
                <section>
                  ...
                  <p className="mb-4">
                    ...
                    understand how people use SpryVibe Video Editor.
                  </p>
                  <p>
                ...
                <section>
                  ...
                  <p className="mb-4">
                    SpryVibe Video Editor integrates with these services:
                  </p>
                  <ul className="list-disc pl-6 mb-4 space-y-2">
                    <li>
                ...
                <section>
                  ...
                  <p className="mb-4">
                    SpryVibe Video Editor is completely open source. You can review our code,
